define(["Operator"], function(Operators) {
    /**
...
// Built in functions
    ...
    /**
     * Returns the String form of the Fact that can be parsed by Fact.getFactFromString()
     * 
     * @returns {String} The String form of the Fact that can be parsed by Fact.getFactFromString()
     */
    ...
    Fact.prototype.getCopy = function() {
        return ret.getFactFromString(this.toParsableString());
    };
    ...
    Fact.prototype.getNegation = function() {
        return ret.createFactFromComponents(this, null, Operators.NEG);
    };
    ...
    var ret = {
         ...
         */
        createFactFromComponents: function(arg0, arg1, op) {
            // Get a deep copy of arg0 and arg1 and create the Fact from that
            var newArg0 = (arg0 !== null) ? this.getFactFromString(arg0.toParsableString()) : null;
            var newArg1 = (arg1 !== null) ? this.getFactFromString(arg1.toParsableString()) : null;
         ...
         */
        getFactFromString: function(data) {
            // Init
            var current = "";
            var subFactString;
            var index = 0;
            ...
            // Case 2: (FACT OP FACT)
                ...
                for (var search = index; search <= endex; search++) {
                    ...
                    var tryOp = Operators.getOperatorFromString(current);
                    if (current === "(") {
                        parenCount++;
                    } else if (current === ")") {
                        parenCount--;
                ...
                arg0 = this.getFactFromString(subFactString);

                // Get the Operator
                var op = Operators.getOperatorFromString(data[midpoint]);

                // Get arg1
                var arg1;
                subFactString = data.substring(midpoint + 1, endex);
                arg1 = this.getFactFromString(subFactString);

                // Create the Fact
                return new Fact(arg0, arg1, op);
            }
            // Case 3: ~(FACT)
            else if (Operators.getOperatorFromString(current).equals(Operators.NEG) &&
                    data[index + 1] === "(") {
                // Move up a char
                index++;
                ...
                return new Fact(this.getFactFromString(subFactString), null, Operators.NEG);
         ...
         * @returns {Fact} The resulting Fact
         */
        getFactFromHTMLString: function(displayString, prettyPrinted) {
            ...
            // Return
            return this.getFactFromString(displayString);
        }
    };
    return ret;
});